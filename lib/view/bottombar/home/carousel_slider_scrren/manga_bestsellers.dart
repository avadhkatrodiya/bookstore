...
class MangaBestSellers extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: mangabestsellers.length,
          itemBuilder: (context, index) {
            return Padding(
              padding: EdgeInsets.only(top: Get.height * 0.01),
              child: CommanContainer(
                title: mangabestsellers[index].title,
                images: mangabestsellers[index].images,
                price: mangabestsellers[index].price,
              ),
            );
          },
        ),
